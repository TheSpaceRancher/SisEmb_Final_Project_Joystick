...
#include <usb.h>
   ...
   //////////////////////////////////////////////////////////////////
    ...
    const char USB_CLASS_SPECIFIC_DESC[] = 
    {
      ...
      //hid report descriptor for interface 1 (joystick)
         ...
         0x81, 0x06, // input (data, variable, absolute) [axes]
         0x75, 0x08, // report size (8)
   ...
   //config 1
      //interface 0 (mouse)
         52,
      //interface 1 (joystick)  (4 bytes report: buttons + X + Y + pad; descriptor length = 24)
         24
   };
...
//////////////////////////////////////////////////////////////////
   ...
   #DEFINE USB_TOTAL_CONFIG_LEN      59 //config+interface+class+endpoint (2 interfaces)
   ...
   //endpoint descriptor 1
      ...
      //interface descriptor 1 (JOYSTICK)
   ...
   //NOTE: DUE TO A LIMITATION OF THE CCS CODE, ALL HID INTERFACES MUST START AT 0 AND BE SEQUENTIAL
